...
declare function GoogleOAuthProvider({
  clientId,
  onScriptLoadSuccess,
  onScriptLoadError,
  children,
...
declare type CredentialOnSuccess = (
...
declare function useGoogleLogin(
...
declare function useGoogleOneTapLogin({
  onSuccess,
  onError,
  promptMomentNotification,
 ...
 */
declare function hasGrantedAllScopesGoogle(
 ...
 */
declare function hasGrantedAnyScopeGoogle(
  tokenResponse: TokenResponse,
  firstScope: string,
  ...restScopes: string[]
): boolean;
